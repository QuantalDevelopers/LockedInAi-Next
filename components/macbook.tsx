...
export const MacbookScroll = ({
  ...
  return (
    <motion.div
      whileHover="hover"
      whileTap="hover"
      className="group mx-auto -mt-20 flex max-w-2xl flex-shrink-0 scale-[0.45] transform flex-col items-center justify-start  py-0 [perspective:800px] sm:-mt-10 sm:scale-[0.7] md:-mt-0 md:scale-100 md:py-20"
    >
      {/* Lid */}
      <Lid src={src} />
      {/* Base area */}
      <div className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-[#272729]">
        ...
        {showGradient && (
          <div className="absolute inset-x-0 bottom-0 z-50 h-40 w-full bg-gradient-to-t  from-charcoal via-charcoal to-transparent"></div>
        )}
