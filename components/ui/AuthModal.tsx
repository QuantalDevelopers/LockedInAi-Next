        ...
        <div className="w-full flex items-center justify-center p-4 sm:p-2">
          <div className="rounded-lg p-6 w-full max-w-sm">
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center w-full border border-gray-300 rounded-md py-2 text-gray-700  mb-4"
            >
              {/* Google Icon */}
              <svg
                className="mr-2"
              ...
              <span className="text-white hover:text-gray-400">Continue with Google</span>
            </button>
